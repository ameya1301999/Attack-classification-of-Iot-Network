...
class Flow:
    ...
    def get_data(self) -> dict:
        ...
        data = {
            ...
            "fwd_seg_size_avg":float(packet_length.get_mean(PacketDirection.FORWARD)),
            "bwd_seg_size_avg": float(packet_length.get_mean(PacketDirection.REVERSE)),
            "subflow_fwd_pkts" : packet_count.get_total(PacketDirection.FORWARD),
            "subflow_bwd_pkts" : packet_count.get_total(PacketDirection.REVERSE),
    ...
    def update_subflow(self, packet):
        ...
        if (packet.time - (last_timestamp / 1e6)) > config.CLUMP_TIMEOUT:
    ...
    def update_active_idle(self, current_time):
        ...
        """
        if (current_time - self.last_active) > config.ACTIVE_TIMEOUT:
        ...
        if direction == PacketDirection.FORWARD:
            ...
            if self.forward_bulk_start_tmp == 0:
                ...
                if (
                    ...
                    self.forward_bulk_count_tmp += 1
                    self.forward_bulk_size_tmp += payload_size
                    if self.forward_bulk_count_tmp == config.BULK_BOUND:
                    ...
                    elif self.forward_bulk_count_tmp > config.BULK_BOUND:
            ...
            if self.backward_bulk_start_tmp == 0:
                ...
                if (
                    ...
                    self.backward_bulk_count_tmp += 1
                    self.backward_bulk_size_tmp += payload_size
                    if self.backward_bulk_count_tmp == config.BULK_BOUND:
                    ...
                    elif self.backward_bulk_count_tmp > config.BULK_BOUND:
